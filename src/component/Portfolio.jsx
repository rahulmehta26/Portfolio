...
const ProjectCard = ({info}) => {
    ...
    const scrollY = useTransform(scrollYProgress, [0, 1], [-100, 200] )
    ...
    return(
      <section className='h-screen w-full mt-24 '  >
        ...
        <div className='flex gap-x-6 justify-center items-center' >
            ...
            <motion.div className='flex flex-col gap-10 flex-1' style={{y:scrollY}} >
...
const Portfolio = () => {
  ...
  return (
    <div ref={ref} className='relative w-[75%] mx-auto' >
        ...
        {
            projectData?.map((item) => <ProjectCard key = {item.id} info = {item} /> )
        }
    </div>
  );
};
